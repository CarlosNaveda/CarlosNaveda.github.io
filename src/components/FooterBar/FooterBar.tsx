...
export default function FooterBar() {
    ...
    return (
        <footer className="footer flex flex-col items-center justify-center gap-8 md:gap-4 h-[700px] md:h-auto md:flex-row md:items-center md:justify-center bg-(var(--my_background))"> 
            ...
            <ul className='footer-social flex flex-row justify-center gap-4 w-[275px] md:self-center md:flex-1'>    
            ...
            <div className='footer-text text-[14px] flex flex-col items-center justify-center w-[275px] text-justify md:w-[80%] md:flex-1'>  
