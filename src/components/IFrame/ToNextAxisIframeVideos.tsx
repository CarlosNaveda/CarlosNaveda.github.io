...
const ToNextAxisIframeVideos = ({video}: {video: IframeVideos}) => {
    ...
    return (
        <>  
            ...
            <div className="toNextAxis-last-videos w-full max-w-3xl aspect-video cursor-pointer flex flex-col items-center justify-center gap-2 font-outfit" onClick={() => setVideoActive(video.source)}>                
