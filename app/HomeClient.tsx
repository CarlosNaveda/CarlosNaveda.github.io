...
export default function HomeClient({ mapPosts }: { mapPosts: postType[] }) { 
  ...
  return (    
    <main>
      {/* Hero */}
      <section id={mapSections['inicio']} className="hero-page min-h-screen flex flex-col items-center justify-center gap-4 text-center px-8 scroll-mt-[46px] md:scroll-mt-[56px] lg:scroll-mt-0">              
      ...
      {/* Sobre mí */}
      <section id={mapSections['sobreMi']} className="about-me-page min-h-screen flex flex-col items-center justify-center gap-10 px-8 text-balanced scroll-mt-[46px] md:scroll-mt-[56px] lg:scroll-mt-0">                  
      ...
      <div className="job-page flex flex-col">        
         <section id={mapSections['experiencia']} className="min-h-screen flex flex-col items-center justify-center gap-8 md:gap-20 p-8 text-balanced scroll-mt-[46px] md:scroll-mt-[56px] lg:scroll-mt-0">                    
      ...
      <div className="toNextAxis-page flex flex-col relative">                       
        <section id={mapSections['tonextaxis']} className="min-h-screen flex flex-col items-center justify-center gap-2 md:gap-10 p-8 text-balanced scroll-mt-[46px] md:scroll-mt-[56px] lg:scroll-mt-0">                                
      ...
      {/* Blog Preview*/}
      <section id={mapSections['blog']} className="blog-page min-h-screen flex flex-col items-center justify-center gap-4 md:gap-10 p-8 text-balanced scroll-mt-[46px] md:scroll-mt-[56px] lg:scroll-mt-0">                  
